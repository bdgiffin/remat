...
def plot_state_covering(time_steps, stress, state_name):
    ...
    # just a text in the north center of the plot
    # ax1.text(0.5, 0.95, 'backward →',
    ...
    # add color to the text label in the legend 


    # leg = plt.legend(['forward', 'backward'], loc='upper right', fontsize='medium')
    ...
    # ax1.text(0.95, 0.05,  'backward \n⟵⟵⟵↤',
    #          horizontalalignment='right',
    #          verticalalignment='center',
    #          transform=ax1.transAxes,
    #          fontsize=11, color=color2)  

    # ax1.text(0.05, 0.95, 'forward \n↦⟶⟶⟶',

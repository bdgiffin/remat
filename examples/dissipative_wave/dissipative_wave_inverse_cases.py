...
CASES = {
    ...
    "case3_high_contrast": {
        "description": "Higher-contrast layered profile for stronger reflections.",
        "args": [
            "--nx", "220", "--ny", "80",
            "--nsteps", "6", "--nsub-steps", "100", "--dt", "9e-3",
            "--n-layers", "4", "--n-sensors", "14",
            "--impact-velocity", "1.05", "--source-window-fraction", "0.09",
            "--true-layers", "0.52,1.82,0.60,1.70",
            "--init-layers", "0.4,0.84,1.24,0.92",
            "--true-tau", "0.35", "--init-tau", "0.24",
            "--max-iters", "24",
            "--lr-layers", "0.001", "--lr-tau", "0.05",
            "--min-layer", "0.2", "--max-layer", "2.0",
            "--min-tau", "0.2", "--max-tau", "1",
        ],
    },
    "case4_tau_focus": {

...
# -----------------------------------------------------------------------------
# Element-wise fourth-best example:
#   longer width, element-wise stiffness, and three region-wise relaxation times
# -----------------------------------------------------------------------------
...
ROUND_CENTER = (8.4, 1.45)
ROUND_RADIUS = 0.45

REG_L2_STIFFNESS = 1.0e-4
REG_TV_STIFFNESS = 7.0e-4
REG_TV_EPS = 1.0e-5
...
OUTPUT_DIR = THIS_DIR / "inverse_outputs_fourth_best_example"
OUTPUT_JSON = OUTPUT_DIR / "fourth_best_example_result.json"
OUTPUT_PLOT = OUTPUT_DIR / "fourth_best_example_summary.svg"
...
def save_summary_plot(
    ...
    fig.tight_layout()
    fig.savefig(OUTPUT_PLOT, dpi=200, metadata={"Title": "Element-wise dissipative wave fourth-best example"})
    fig.clf()
    plt.close(fig)

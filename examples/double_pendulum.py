...
def animate_state():
    ...
    for e in range(0,Ntruss):
        ...
        points[:,1] = 600 - points[:,1]
        #pygame.gfxdraw.line(window, "Grey", points[0,0], points[0,1], points[1,0], points[1,1], 4)
    ...
    for e in range(0,Npoints):
        ...
        color   = (0,0,0)
        pygame.gfxdraw.aacircle(window, point_x, point_y, radius, color)
        pygame.gfxdraw.filled_circle(window, point_x, point_y, radius, color)
        # create tracers

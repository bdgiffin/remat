...
typedef Truss<UniaxialViscoplasticity<Fixed_E,Rational,Real> > TrussT_fixed_viscoplastic_adj_float;
typedef Truss<UniaxialViscoelasticity<Real,Real,Real> >           TrussT_float_visco_truss;
typedef Truss<UniaxialViscoelasticity<Fixed_E,Rational,Fixed_E> > TrussT_fixed_visco_truss;
typedef Truss<UniaxialViscoelasticity<Fixed_E,Rational,Real> >    TrussT_fixed_visco_truss_adj_float;
...
System<ElementT,TrussT_float,Real,Real,Real,true> remat_float_truss_viscoplastic_adjoint;
System<ElementT,TrussT_fixed_viscoplastic_adj_float,Fixed_V,Fixed_U,Rational,true> remat_fixed_truss_viscoplastic_adj_float_adjoint;
System<ElementT,TrussT_float_visco_truss,Real,Real,Real,true> remat_float_truss_visco_adjoint;
System<ElementT,TrussT_fixed_visco_truss_adj_float,Fixed_V,Fixed_U,Rational,true> remat_fixed_truss_visco_adj_float_adjoint;
...
extern "C" {
  ...
  void set_integrator_type(const char* integrator_type) {
    ...
    } else if (integrator_type_string == "float_truss_viscoplastic_adjoint") {
      remat = &remat_float_truss_viscoplastic_adjoint;
    } else if (integrator_type_string == "fixed_truss_viscoplastic_adj_float_adjoint") {
      remat = &remat_fixed_truss_viscoplastic_adj_float_adjoint;
    } else if (integrator_type_string == "float_truss_visco_adjoint") {
      remat = &remat_float_truss_visco_adjoint;
    } else if (integrator_type_string == "fixed_truss_visco_adj_float_adjoint") {
      remat = &remat_fixed_truss_visco_adj_float_adjoint;
    } else {

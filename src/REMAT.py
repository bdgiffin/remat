...
API.step_forward.argtypes = [c_double, c_int]
API.step_forward.restype  = c_double
API.step_remat_backward.argtypes = [c_int]
API.step_remat_backward.restype  = c_double
API.step_adjoint_backward.argtypes = [c_int]
API.step_adjoint_backward.restype  = c_double
API.set_objective_policy.argtypes = [c_char_p]
API.set_objective_policy.restype  = None
API.get_truss_adjoint_support.argtypes = None
API.get_truss_adjoint_support.restype  = c_int
API.get_truss_adjoint_status.argtypes = None
API.get_truss_adjoint_status.restype  = c_char_p
